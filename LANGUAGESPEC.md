...
**Version:** 1.5.0
**Date:** 2025-12-03
**Status:** Canonical Language Reference for Vibe67 1.5.0 Release
...
Vibe67 has a dedicated boolean type with two values: `yes` and `no`.
...
- Imports all top-level `.v67` files from the repository
- Version specifiers:
  - `@v1.0.0` - Specific tag
...
**Directory behavior:**
- Imports all top-level `.v67` files from the directory
...
```bash
vibe67 program.v67 -o program -L/path/to/libs -lmylib

# SDL3 example
vibe67 sdl_demo.v67 -o sdl_demo $(pkg-config --libs sdl3)
```
...
vibe67 program.v67 -o program

# Compile with C library
vibe67 program.v67 -o program -lm

# Specify target architecture
vibe67 program.v67 -o program -arch arm64
vibe67 program.v67 -o program -arch riscv64

# Hot reload mode (Unix)
vibe67 --hot program.v67
